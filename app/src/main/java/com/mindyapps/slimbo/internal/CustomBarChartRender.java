...
public class CustomBarChartRender extends BarChartRenderer {
    ...
    public CustomBarChartRender(BarDataProvider chart, ChartAnimator animator,
    ...
    public void setContext(Context context) {
        CustomBarChartRender.context = context;
    }
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        mBarBorderPaint.setStrokeWidth(convertDpToPixel(dataSet.getBarBorderWidth()));
